<template>
	<section id="page-installed">
		<div class="installed">
			...
			<p>{{ $t("installed.line1") }}</p>
			<p>{{ $t("installed.line2") }}</p>
			<p>{{ $t("installed.line3") }}</p>
		</div>
