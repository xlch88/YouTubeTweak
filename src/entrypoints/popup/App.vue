...
> = {
	...
	insights: {
		component: defineAsyncComponent(() => import("./pages/insights.vue")),
		icon: "M2.5 12s3.5-6 9.5-6 9.5 6 9.5 6-3.5 6-9.5 6-9.5-6-9.5-6Z M12 9a3 3 0 1 1 0 6 3 3 0 0 1 0-6Z",
		viewBox: "1.65 5.15 20.7 13.7",
		strokeWidth: 2.1,
	},
	general: {
